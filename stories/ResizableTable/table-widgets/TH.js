...
const TH = ( props ) => {
    ...
    return <th
        ...
        id={theadId}
    >
        <p style={{ display: 'flex', margin: 0, width: '100%', alignItems: 'center', }}>
            <span
            ...
            >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill={column.isFixed ? "green" : 'gray'} viewBox="0 0 16 16">
