const { randomIdGenerator } = require("../utility/utils.js");
  ...
  return (
    <>
      <svg
        ...
        width="17"
        height="17"
        fill={column.isFixed ? "green" : "gray"}
        viewBox="0 0 16 16"
      >
...
const TH = (props) => {
  ...
  return (
    <th
      className={`${
        column.isFixed ? "fixed-table-column fixed-cell " : ""
      } table-header`}
      scope="col"
      style={{
      ...
      >
        ...
        >
          ...
          {column.sortable ? (
            <span
              style={{
                rotate: column.sortingOrder === "desc" ? "180deg" : "",
                transition: "all 0.3s",
              }}
            >
              <ChevronIcon size={16} />
